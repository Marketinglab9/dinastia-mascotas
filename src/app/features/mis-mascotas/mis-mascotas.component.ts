...
import { RouterModule } from '@angular/router'; // Vital para navegar a /mascotas/nueva
...
@Component({
            ...
            <div class="pets-grid">
                ...
                <mat-card *ngFor="let pet of pets" class="pet-card">
                    ...
                    <mat-card-actions align="end">
                        <button mat-button color="primary">VER HISTORIAL</button>
                    </mat-card-actions>
                </mat-card>

                <!-- Tarjeta "Placeholder" para invitar a añadir otra -->
    ...
    styles: [`
        ...
        .add-btn {
            ...
            border-radius: 24px;
            font-weight: 600;
            background-color: #2E7D32; /* Verde corporativo */
            color: white;
        }
        ...
        .pet-content { padding: 16px 20px 0; }
        ...
        .stat {
            ...
            mat-icon { font-size: 18px; width: 18px; height: 18px; color: #81c784; }
        }
        ...
        .add-card-placeholder {
            ...
            cursor: pointer;
            min-height: 340px; /* Altura aprox de las otras cards */
            transition: all 0.2s;
            ...
            &:hover {
                ...
                .icon-circle { background-color: #2E7D32; color: white; }
                h3 { color: #2E7D32; }
            }
        }
